...
type SpeechRecognitionResultEntry = { transcript: string; confidence: number }
type SpeechRecognitionResult = { isFinal: boolean; [index: number]: SpeechRecognitionResultEntry }
